...
class Tests(unittest.TestCase):
    ...
    def test001_reachability_aa(self):
    ...
    def test001_reachability_bb(self):
        rc, msg, loss = ping("bb")
        if rc != 0 or loss > 0:
            self.fail(msg)
        pass
    ...
    def test001_reachability_cc(self):
        rc, msg, loss = ping("cc")
        if rc != 0 or loss > 0:
            self.fail(msg)
        pass
    ...
    def test001_reachability_dd(self):
        rc, msg, loss = ping("dd")
        if rc != 0 or loss > 0:
            self.fail(msg)
        pass
    ...
    def test001_reachability_outside(self):
