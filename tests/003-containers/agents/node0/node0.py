...
class node0(DispatchAgent):
    ...
    @agentmethod()
    def test003containers(self, msg):
...
class Test003Containers(unittest.TestCase):


    def test_reachability_node1(self):
    ...
    def test_reachability_node2(self):
        dtl = DeterLabTesting.DeterLabTesting()
    ...
    def test_reachability_node3(self):
        dtl = DeterLabTesting.DeterLabTesting()
